...
** Type erasure use case
   Create a typeerased wrapper that is trivially relocatable
...
** Other use-cases are handled in a similar way
   ...
   From Arthur O'Dwire's [[https://quuxplusone.github.io/blog/2025/10/18/thoughts-on-p3858r0/][Thoughts on P3858R0]]:
  #+begin_src C++
    template<class T>
